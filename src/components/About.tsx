  ...
  return (
    ...
    >
      <div style={{ borderTop: '1px solid #2A2A2A' }} className="pt-8 md:pt-16">
        ...
        >
          {[
            { num: '100%', label: 'ישיר מהמפעל', target: 100, suffix: '%', duration: 1800 },
            { num: '3', label: 'דגמים בקולקציה', target: 3, suffix: '', duration: 2800 },
            { num: '72H', label: 'אצלך בבית', target: 72, suffix: 'H', duration: 3800 },
