...
const specs = [
  ...
  },
  {
    ...
    sub: 'תקן TÜV / ISO 4210-2',
    body: 'האופניים נבדקו, אושרו ועומדים בתקן הבינלאומי על ידי מעבדות TÜV המחמירות בעולם. כי על בטיחות לא מתפשרים.',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-16">
        ...
        <div className="mb-14 lg:mb-16">
          ...
          >
            כל פרט בSpinz נבחר בכוונה — לא בשביל המראה בלבד, אלא בשביל הרכיבה האמיתית.
          </motion.p>
        </div>
