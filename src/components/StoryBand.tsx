...
export default function StoryBand() {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative mx-auto max-w-7xl w-full px-6 lg:px-16 py-10 lg:py-32">
        <div style={{ maxWidth: '480px' }}>
          ...
          >
            Spinz התחילה ברחובות של תל אביב. האמנו שאופניים טובים בעיר לא צריכים לעלות הון או להסתבך בהילוכים וכבלים שנתקעים, אלא פשוט להיות יפים, אמינים וכיף לרכוב עליהם.
          </motion.p>
