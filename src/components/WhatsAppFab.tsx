...
export default function WhatsAppFab() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 left-6 lg:bottom-8 lg:left-8 z-50 flex items-center justify-center"
      style={{ filter: 'drop-shadow(0 2px 6px rgba(0,0,0,0.3))' }}
    >
      <svg viewBox="0 0 24 24" className="w-10 h-10 lg:w-12 lg:h-12" fill="#25D366" xmlns="http://www.w3.org/2000/svg">
