...
export const colorVariants = [
  { id: 'mat',   label: 'שחור מט',  image: '/assets/bike-mat-cut.png',   hex: '#1A1A1A', skuCode: 'MAT', slug: 'mat'   },
  { id: 'beige', label: "בז'",      image: '/assets/bike-beige-cut.png', hex: '#C4A882', skuCode: 'BEI', slug: 'beige' },
  { id: 'olive', label: 'ירוק זית', image: '/assets/bike-olive-cut.png', hex: '#7D9168', skuCode: 'OLG', slug: 'olive' },
];
