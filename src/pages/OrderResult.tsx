...
const COPY = {
  he: {
    ...
    slow: 'האישור מתעכב. אם חויבת, ההזמנה תיקלט מעצמה ואין צורך לשלם שוב.',
  ...
  en: {
    ...
    slow: 'Confirmation is taking a while. If you were charged, the order will register on its own, so do not pay again.',
    home: 'Back to home',
    contact: 'Contact us',
  },
} as const;
