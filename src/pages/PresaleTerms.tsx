        ...
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <ul style={{ margin: 0, paddingInlineStart: '18px', fontFamily: "'Heebo', sans-serif", fontSize: '14.5px', color: MUTED, lineHeight: 1.9 }}>
              <li>האופניים בהזמנה מוקדמת, כלומר <b>טרם הגיעו למלאי</b>.</li>
              <li>מועד אספקה משוער: <b>{presale.arrivalLabel}</b>.</li>
              <li>ניתן לבטל ולקבל <b>החזר מלא</b> בכל שלב לפני המסירה.</li>
              <li>גם אחרי קבלת האופניים יש 14 יום לבטל, <b>ואנחנו לא גובים דמי ביטול</b>.</li>
          ...
          <Section title="4. זכות ביטול">
            ...
            <p style={{ margin: 0 }}>
              ...
              נזק, פחת או בלאי שנגרמו למוצר לאחר מסירתו עשויים להקים חבות לפיצוי בגובה ירידת הערך,
              בהתאם לדין.
            </p>
          </Section>
          ...
          <Section title="5. דמי ביטול והחזרת המוצר">
            ...
            <p style={{ margin: 0 }}>
              לגבי משלוח ההחזרה: בביטול מרצון, החזרת המוצר אלינו היא באחריות הלקוח ועל חשבונו.
              <b> אם המוצר הגיע פגום, לא תקין, או שהאספקה התעכבה מעבר למועד שנמסר, האיסוף על חשבוננו</b>,
              ונדאג לתאם אותו מולכם.
            </p>
          </Section>

          <Section title="6. אופן הביטול וההחזר">
            <p style={{ margin: 0 }}>
              ניתן להודיע על ביטול באמצעות <a href="/cancel-order" style={{ color: GOLD, fontWeight: 700 }}>טופס ביטול עסקה</a> שבאתר,
              בדוא״ל <a href={`mailto:${COMPANY.email}`} style={{ color: GOLD }}>{COMPANY.email}</a>,
          ...
          <Section title="7. אחריות">
            <p style={{ margin: 0 }}>
              ...
              תאונה, שינויים שבוצעו במוצר, או <b>הרכבה שלא בוצעה בהתאם להוראות ההרכבה המצורפות</b>.
              האופניים מגיעים מורכבים ברובם; השלמת ההרכבה לפי ההוראות והסרטון המצורפים אינה פוגעת באחריות.
            </p>
          </Section>
