        ...
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          <Section title="3. אחריות מוגבלת">
            <ul style={{ margin: 0, paddingInlineStart: '18px' }}>
              ...
              <li style={{ marginBottom: '8px' }}>
                <b>גימור וצבע:</b> הגימור (צבע מאט / ציפוי אבקה) עשוי להציג שוני קל בגוון בין יחידות
                ובין התצוגה במסך למוצר בפועל – שוני כאמור אינו נחשב פגם. האחריות אינה חלה על שריטות,
                שפשופים, דהייה או שינויי צבע הנובעים מחשיפה לשמש, למזג אוויר, לכימיקלים, מטיפוח לא נכון
                או מבלאי סביר. פגם ייצור מובהק בגימור (כגון קילוף או בועות שמקורם במפעל ואינם תוצאת
                שימוש) יטופל בכפוף לכך שדווח <b>לפני הרכבה ושימוש</b>, בתוך 7 ימים ממועד קבלת המוצר
                ובצירוף תיעוד מצולם.
              </li>
              <li>
