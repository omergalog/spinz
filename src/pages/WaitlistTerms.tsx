    ...
    <div style={{ backgroundColor: DARK, minHeight: '100vh', fontFamily: "'Heebo', sans-serif", cursor: 'none' }} dir="rtl">
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: 'clamp(40px, 6vw, 80px) 32px' }}>
        ...
        {[
          ...
          {
            title: '4. הסכמה לקבלת דברי פרסומת',
            body: 'במסירת פרטיי, אני מסכים/ה לקבל דברי פרסומת ועדכונים מ-SPINZ באמצעי התקשורת שמסרתי (לרבות דוא"ל ומסרונים), בהתאם לחוק התקשורת (בזק ושידורים), התשמ"ב-1982.',
          },
          {
            title: '5. שיתוף מידע עם צדדים שלישיים',
            body: 'המותג לא מוכר, מעביר או חולק את פרטיכם האישיים עם כל צד שלישי, למעט ספקי תשתית טכנית (כגון Supabase לאחסון הנתונים) המחויבים בסודיות.',
          },
          {
